...
public class List_NormalAdapter extends ArrayAdapter {

    private ArrayList<pNormal_list> listData;
    private AppCompatActivity aActivity;
    private iFunction iFt = new iFunction();

    private String REGISTER_URL;

    public List_NormalAdapter(AppCompatActivity aActivity, ArrayList<pNormal_list> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View v = inflater.inflate(R.layout.list_normal, parent, false);
        final pNormal_list pList = listData.get(position);
