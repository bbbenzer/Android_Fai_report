...
public class List_PieAdapter extends ArrayAdapter {
    private ArrayList<pPie_list> listData;
    private AppCompatActivity aActivity;
    private iFunction iFt = new iFunction();

    private String REGISTER_URL;

    public List_PieAdapter(AppCompatActivity aActivity, ArrayList<pPie_list> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View v = inflater.inflate(R.layout.list_pie, parent, false);
        final pPie_list pList = listData.get(position);
